...
var GuidePagesLite = (function () {
    ...
    var stepOverDelegate = function (displaying_div_id, come_div_id) {
        console.log('GuidePages Step Over: ' + displaying_div_id + " to " + come_div_id);
    };
    return {
        init: function () {
            steps = [];
        ...
        next: function () {
            ...
            if (!stepOverDelegate(displaying_div_id, next_div_id))return false;
            if (currentStepId + 1 >= steps.length) {
                doneDelegate();
                return false;
            }
        ...
        prev: function () {
            ...
            if (!stepOverDelegate(displaying_div_id, prev_div_id))return false;
